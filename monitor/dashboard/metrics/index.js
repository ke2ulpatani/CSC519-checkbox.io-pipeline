...
try
{
	checkbox = fs.readFileSync(path.join(__dirname,'checkbox.txt')).toString();
}
catch(e)
{
	console.log(e);
	throw new Error("Missing required checkbox.txt file");
}
...
{
	console.log(e);
	throw new Error("Missing required itrust.txt file");
}
